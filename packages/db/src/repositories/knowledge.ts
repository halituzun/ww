...
function parseKnowledge(value: unknown): KnowledgeRow {
  ...
  const parsed: KnowledgeRow = Object.freeze({
    ...
    source_task_id: optionalEntityId(storedUuid(row['source_task_id'] ?? NIL_UUID, 'knowledge.source_task_id'), 'knowledge.source_task_id'),
    source_message_id: optionalEntityId(storedUuid(row['source_message_id'] ?? NIL_UUID, 'knowledge.source_message_id'), 'knowledge.source_message_id'),
    status: storedEnum(row['status'], KNOWLEDGE_STATUSES, 'knowledge.status'),
    superseded_by: optionalEntityId(storedUuid(row['superseded_by'] ?? NIL_UUID, 'knowledge.superseded_by'), 'knowledge.superseded_by'),
