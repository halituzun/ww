...
```bash
docker compose up -d
WW_REQUIRE_INTEGRATION=1 pnpm test          # 2047 test, 10 paket
...
faz kapatırken `test:live` ayrıca koşulmalıdır. Toplam kapı: **2051 test**
(2026-08-20 ölçümü). Ayrıca `pnpm wiring:check` — bağlanmamış kod kapısı.
