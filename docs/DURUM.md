...
| Üretim kaynağı | 410 dosya, 57.483 satır |
| Test dosyası | 295 |
| Test durumu (`it(` sayımı) | 2028 |
| Servis gerektirdiği için atlanabilen test dosyası | 47 (`skipIf`) |
| Colocation ile testsiz kaynak dosya | 141 / 410 |
| ClickHouse migration | 11 |
