...
export const NAV_ROUTES: readonly NavRoute[] = [
  ...
  { id: "tasks", label: "Görevler", group: "project", icon: "tasks" },
  { id: "files", label: "Dosyalar", group: "project", icon: "files" },
  { id: "chat", label: "PM sohbeti", group: "project", icon: "chat" },
  { id: "preview", label: "Önizleme", group: "project", icon: "preview" },
  { id: "projects", label: "Projeler", group: "system", icon: "projects" },
  { id: "providers", label: "API'ler", group: "system", icon: "providers" },
  { id: "budget", label: "Kontör", group: "system", icon: "budget" },
